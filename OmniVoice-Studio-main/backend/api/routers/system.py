...
from services.model_manager import get_model_status, get_best_device, resolve_omnivoice_checkpoint_path
...
def system_info():
    ...
    try:
        return {
            ...
            "model_checkpoint": str(resolve_omnivoice_checkpoint_path()),
